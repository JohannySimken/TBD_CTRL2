...
(3, 1, 'Reparar reja de parque', 'Reja oxidada y suelta en Parque Forestal', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6488 -33.4572)'), '2026-07-22', true); -- ~350m del usuario, vence pronto

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(3, 1, 'Limpieza de plaza', 'Acumulación de basura tras evento', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6600 -33.4650)'), '2026-08-05', false); -- ~1.6km del usuario

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(3, 1, 'Retirar escombros vereda', 'Escombros de obra bloquean vereda', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6492 -33.4578)'), '2026-06-01', '2026-05-30 11:00:00', true); -- ~200m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(3, 1, 'Pintar cruce peatonal', 'Demarcación borrada', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6420 -33.4520)'), '2026-06-10', '2026-06-08 10:00:00', true); -- ~1.1km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(3, 14, 'Poda de árboles', 'Ramas invaden la calle', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6100 -33.4900)'), '2026-05-25', '2026-05-24 16:00:00', true); -- ~5.5km, fuera de radio 5km aprox

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date) VALUES
(3, 1, 'Cambiar tapa de alcantarilla', 'Tapa rota, riesgo de accidente', 'EXPIRED',
 ST_GeogFromText('SRID=4326;POINT(-70.6550 -33.4600)'), '2026-03-15');
...
(4, 2, 'Fuga de agua potable', 'Filtración en vereda de Av. 11 de Septiembre', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6135 -33.4340)'), '2026-07-25', true); -- ~150m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(4, 11, 'Poste de luz apagado', 'Cuadra completa sin iluminación nocturna', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6112 -33.4312)'), '2026-08-01', false); -- ~250m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(4, 11, 'Cambio de ampolleta LED', 'Poste con luz intermitente', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6118 -33.4320)'), '2026-06-05', '2026-06-04 09:30:00', true); -- ~200m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(4, 2, 'Reparar grieta en vereda', 'Grieta profunda genera riesgo de caídas', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6200 -33.4400)'), '2026-06-12', '2026-06-11 15:00:00', true); -- ~1.2km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(4, 2, 'Limpieza de sumideros', 'Sumidero tapado provoca inundación', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6350 -33.4450)'), '2026-05-28', '2026-05-27 13:20:00', true); -- ~2.4km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date) VALUES
(4, 2, 'Retiro de escombros', 'Escombros abandonados en bandejón', 'EXPIRED',
 ST_GeogFromText('SRID=4326;POINT(-70.6250 -33.4380)'), '2026-03-20');
...
(5, 12, 'Semáforo intermitente', 'Semáforo parpadea en amarillo constantemente', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5775 -33.4090)'), '2026-07-18', true); -- ~150m, vence muy pronto

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(5, 3, 'Poda de árboles caídos', 'Rama grande obstruye vereda', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5900 -33.4200)'), '2026-08-10', false); -- ~1.9km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(5, 12, 'Reparación de semáforo peatonal', 'Botón de cruce no funciona', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5780 -33.4095)'), '2026-06-02', '2026-06-01 12:00:00', true); -- ~100m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(5, 3, 'Reposición de pasto', 'Área verde dañada por obras', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5820 -33.4130)'), '2026-06-15', '2026-06-14 10:45:00', true); -- ~600m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(5, 3, 'Limpieza de grafitis', 'Muro municipal rayado', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6000 -33.4300)'), '2026-05-18', '2026-05-17 14:00:00', true); -- ~2.6km
...
(6, 13, 'Bache profundo Av. Pajaritos', 'Bache genera riesgo para vehículos', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.7648 -33.5175)'), '2026-07-21', true); -- ~150m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(6, 4, 'Corte de pasto plaza central', 'Pasto crecido en plaza de Maipú', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.7750 -33.5250)'), '2026-08-08', false); -- ~1.7km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(6, 13, 'Repavimentación calle interior', 'Calle con múltiples baches', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.7660 -33.5190)'), '2026-06-07', '2026-06-06 08:30:00', true); -- ~200m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(6, 4, 'Reparación de reja municipal', 'Reja de acceso a plaza dañada', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.7700 -33.5220)'), '2026-05-30', '2026-05-29 09:00:00', true); -- ~800m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date) VALUES
(6, 4, 'Retiro de micro-basural', 'Basural en sitio eriazo', 'EXPIRED',
 ST_GeogFromText('SRID=4326;POINT(-70.7900 -33.5300)'), '2026-04-05');
...
(7, 14, 'Riego de plaza seca', 'Áreas verdes sin riego hace semanas', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6005 -33.4598)'), '2026-07-19', true); -- ~100m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(7, 7, 'Reparar juegos infantiles', 'Columpio roto en plaza de barrio', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6100 -33.4700)'), '2026-08-12', false); -- ~1.6km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(7, 14, 'Poda de setos', 'Setos crecidos invaden vereda', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5998 -33.4592)'), '2026-06-03', '2026-06-02 11:15:00', true); -- ~80m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(7, 7, 'Reparación de banca pública', 'Banca de plaza rota', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.6050 -33.4650)'), '2026-05-22', '2026-05-21 10:00:00', true); -- ~950m
...
(8, 15, 'Contenedores desbordados', 'Basura acumulada en esquina', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5755 -33.6115)'), '2026-07-20', true); -- ~100m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(8, 6, 'Reposición de señalética vial', 'Señal PARE derribada', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5850 -33.6200)'), '2026-08-03', false); -- ~1.5km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(8, 15, 'Limpieza de vertedero ilegal', 'Microbasural en sitio eriazo', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5762 -33.6125)'), '2026-06-09', '2026-06-08 14:40:00', true); -- ~150m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(8, 6, 'Reparación de vereda agrietada', 'Vereda levantada por raíces', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5900 -33.6250)'), '2026-05-31', '2026-05-30 09:50:00', true); -- ~1.9km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date) VALUES
(8, 6, 'Retiro de árbol caído', 'Árbol bloquea calzada tras temporal', 'EXPIRED',
 ST_GeogFromText('SRID=4326;POINT(-70.6000 -33.6300)'), '2026-04-10');
...
(9, 8, 'Poda de árbol peligroso', 'Rama grande a punto de caer sobre la calle', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5397 -33.4462)'), '2026-07-19', true); -- ~50m, vence pronto

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(9, 8, 'Reparar juego infantil', 'Resbalín con estructura suelta', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5420 -33.4480)'), '2026-07-30', true);

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(9, 7, 'Corte de pasto plaza vecinal', 'Pasto crecido hace más de un mes', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5600 -33.4550)'), '2026-08-15', false); -- ~2.3km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(9, 8, 'Reponer luminaria apagada', 'Poste sin luz hace tres noches', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5900 -33.4700)'), '2026-08-20', false); -- ~5.9km, fuera de radio 5km

-- COMPLETED
INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(9, 8, 'Reparar vereda agrietada', 'Grieta profunda frente a casa vecina', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5400 -33.4465)'), '2026-06-01', '2026-05-31 10:00:00', true); -- ~100m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(9, 8, 'Limpieza de canaleta', 'Canaleta obstruida por hojas', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5410 -33.4470)'), '2026-06-05', '2026-06-04 09:00:00', true); -- ~250m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(9, 8, 'Pintura de reja municipal', 'Reja oxidada en acceso a plaza', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5450 -33.4500)'), '2026-06-10', '2026-06-09 15:30:00', true); -- ~800m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(9, 7, 'Retiro de escombros', 'Escombros de poda abandonados', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5550 -33.4600)'), '2026-06-18', '2026-06-17 11:20:00', true); -- ~2km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(9, 8, 'Reparación de bandejón central', 'Áreas verdes dañadas por vehículo', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5700 -33.4650)'), '2026-05-15', '2026-05-14 13:00:00', true); -- ~4.2km

-- EXPIRED
INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date) VALUES
(9, 8, 'Cambio de tapa de alcantarilla', 'Tapa rota, riesgo para peatones', 'EXPIRED',
 ST_GeogFromText('SRID=4326;POINT(-70.5430 -33.4485)'), '2026-04-08');
...
(10, 9, 'Fuga de agua en bandejón', 'Filtración constante en área verde', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5808 -33.3945)'), '2026-07-20', true); -- ~60m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(10, 9, 'Reparar ciclovía dañada', 'Pavimento levantado en ciclovía', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5830 -33.3960)'), '2026-08-02', true);

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(10, 12, 'Semáforo sin energía', 'Intersección sin funcionamiento tras corte de luz', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.5790 -33.4050)'), '2026-08-18', false); -- ~1.4km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, notification_sent) VALUES
(10, 9, 'Poda de setos altos', 'Setos obstruyen visibilidad en cruce', 'PENDING',
 ST_GeogFromText('SRID=4326;POINT(-70.6000 -33.4200)'), '2026-08-25', false); -- ~5.6km, fuera de radio 5km

-- COMPLETED
INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(10, 9, 'Retiro de rama caída', 'Rama bloqueaba parte de la calzada', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5810 -33.3947)'), '2026-06-02', '2026-06-01 08:45:00', true); -- ~120m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(10, 9, 'Reparación de reja parque', 'Reja doblada por accidente vehicular', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5825 -33.3955)'), '2026-06-08', '2026-06-07 14:10:00', true); -- ~350m

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(10, 9, 'Pintura de gimnasio al aire libre', 'Estructuras metálicas oxidadas', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5870 -33.3980)'), '2026-06-14', '2026-06-13 10:30:00', true); -- ~1km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(10, 12, 'Reparación semáforo peatonal', 'Botón de cruce dañado', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5800 -33.4020)'), '2026-06-20', '2026-06-19 16:00:00', true); -- ~1.1km

INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date, completed_at, notification_sent) VALUES
(10, 9, 'Limpieza de plaza mirador', 'Basura acumulada tras fin de semana largo', 'COMPLETED',
 ST_GeogFromText('SRID=4326;POINT(-70.5950 -33.4100)'), '2026-05-20', '2026-05-19 12:00:00', true); -- ~3.7km

-- EXPIRED
INSERT INTO tasks (user_id, sector_id, title, description, status, location, due_date) VALUES
(10, 9, 'Reposición de baldosas', 'Baldosas sueltas en paseo peatonal', 'EXPIRED',
 ST_GeogFromText('SRID=4326;POINT(-70.5840 -33.3965)'), '2026-04-12');



-- Comunas RM
INSERT INTO sectors (name, category, description, location) VALUES
('Alhué','rural','Comuna RM',ST_GeogFromText('SRID=4326;POINT(-71.1000 -34.0330)')),
('Buin','urbano','Comuna RM',ST_GeogFromText('SRID=4326;POINT(-70.7390 -33.7320)')),
('Calera de Tango','rural','Comuna RM',ST_GeogFromText('SRID=4326;POINT(-70.7850 -33.6690)')),
('Cerrillos','urbano','Comuna RM',ST_GeogFromText('SRID=4326;POINT(-70.7060 -33.4970)')),
('Cerro Navia','urbano','Comuna RM',ST_GogFromText('SRID=4326;POINT(-70.7280 -33.4210)'));
